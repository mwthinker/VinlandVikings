...
struct fmt::formatter<vin::Vec2> {
	...
	auto format(const vin::Vec2& p, FormatContext& ctx) const {
...
struct fmt::formatter<vin::hex::Hexf> {
	...
	template <typename FormatContext>
	auto format(const vin::hex::Hexf& hex, FormatContext& ctx) const {
...
struct fmt::formatter<vin::hex::Hexi> {
	...
	template <typename FormatContext>
	auto format(const vin::hex::Hexi& hex, FormatContext& ctx) const {
...
struct fmt::formatter<vin::Vec3> {
	...
	template <typename FormatContext>
	auto format(const vin::Vec3& p, FormatContext& ctx) const {
...
struct fmt::formatter<vin::Vec4> {
	...
	template <typename FormatContext>
	auto format(const vin::Vec4& p, FormatContext& ctx) const {
...
struct fmt::formatter<vin::Color> {
	...
	template <typename FormatContext>
	auto format(const vin::Color& color, FormatContext& ctx) const {
...
struct fmt::formatter<vin::Mat4> {
	...
	template <typename FormatContext>
	auto format(const vin::Mat4& mat, FormatContext& ctx) const {
